...
namespace DaVikingCode.TexturePacker
{
    public class TexturePacker : MonoBehaviour
    {
        ...
        public void AddTexturesToPack(List<string> files)
        {
        ...
        public void Process(bool allow4096Textures = false)
        {
            ...
            if (useCache)
            {
                ...
                string path = Application.persistentDataPath + "/TexturePacker/" + cacheName + "/" + cacheVersion + "/";
        ...
        protected IEnumerator createPack(string savePath = "")
        {
            if (savePath != "")
            {
                if (deletePreviousCacheVersion && Directory.Exists(Application.persistentDataPath + "/TexturePacker/" + cacheName + "/"))
                    foreach (string dirPath in Directory.GetDirectories(Application.persistentDataPath + "/TexturePacker/" + cacheName + "/", "*", SearchOption.AllDirectories))
