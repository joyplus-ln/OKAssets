using UnityEngine;
using DaVikingCode.TexturePacker;
...
public class TexturePackerManager
{
    ...
    /// 添加路径并打包
    public void AddPathAndComplete(string tag, string[] paths, OnAssetPackCompleteDelegate callBack = null, bool isUseCache = false)
    {
